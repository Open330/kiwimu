...
document.addEventListener("DOMContentLoaded", () => {
    ...
    async function ensureData() {
        ...
        loadPromise = fetch("/kiwimu/search-index.json", { credentials: "same-origin" })
            .then((resp) => {
    ...
    function renderResults() {
        ...
        dropdown.innerHTML = results.map((result, index) => {
            ...
            return `<a id="search-result-${index}" href="/kiwimu/wiki/${encodeURIComponent(result.slug)}.html" role="option" aria-selected="false">
